...
<div style="display: inline-flex; justify-content: space-between; align-items: flex-start; width: 100%">
    <div style="flex: 1;">
    ...
    <div style="flex: 1; display: flex; align-items: flex-end;">
        <figure>
            <img src="assets/gitDemos/terrain.png" alt="Terrain Atlas" height="200">
            <figcaption>Terrain Atlas</figcaption>
        </figure>
        <figure>
            <img src="assets/gitDemos/MayorSimIslandDemo.gif" alt="Map Demo" height="200">
